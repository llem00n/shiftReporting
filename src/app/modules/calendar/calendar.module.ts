...
@NgModule({
  declarations: [CalendarComponent, WeekGridComponent, WeekSelectorComponent, TemplatesListComponent, DaySelectorComponent, YearWeekSelectorComponent, ApprovalProcessComponent,
  ],
  imports: [
    CommonModule,
